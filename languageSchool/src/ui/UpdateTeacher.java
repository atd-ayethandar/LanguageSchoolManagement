...
public class UpdateTeacher {
	...
	public void createNode(Teacher t)
	{
		lid = new Label("ID: ");
		...
		lnameErr = new Label("");
		lphoneErr = new Label("");
		tid = new TextField(t.getTeacherID());
		tid.setEditable(false);
		tname = new TextField(t.getTeacherName());
		...
		tphone = new TextField(t.getTeacherPhone());
	...
	public void updateTeacher()
	{
		...
		if(lidErr.getText() == "" && lnameErr.getText() == "" && lphoneErr.getText() == "") {
			if(DBHandler.updateTeacher(id, name, phone)) {
	...
	public GridPane getUpdateTeacher(Teacher t)
	{
		createNode(t);
		defineLayout();
		setStyle();
